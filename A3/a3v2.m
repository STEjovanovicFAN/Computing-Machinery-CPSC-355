...
!note this runs the array unsorted, because i cant fiz my code, and ends 
...
displayArrayTestSorted:
	cmp	i_r, 	size_r			!compare counter to size of array 
	ble	displayArray			!if counter <= size of array brach to displayArray
        sll     i_r,    2,     %o0              !counter *4
